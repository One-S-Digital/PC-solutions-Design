...
// FIX: Corrected import path casing to match file name 'PartnersPage.tsx'.
      ...
      <CartProvider>
        <MessagingProvider>
          <NotificationProvider> 
            <Routes>
              {/* Public Routes - these do not have the MainLayout */}
              <Route path="/login" element={<LoginPage />} />
              <Route path="/signup" element={<SignupPage />} />
              <Route path="/pricing" element={<PricingPage />} />
              <Route path="/parent-lead-form" element={<ParentLeadFormPage />} />
              
              {/* Protected Routes - wrapped in a layout that handles auth */}

...
import { STANDARD_INPUT_FIELD, APP_NAME, ALL_USERS_MOCK } from 'packages/core/src/constants';
...
const LoginPage: React.FC = () => {
  ...
  const demoUsers = ALL_USERS_MOCK.filter(u => u.role !== UserRole.ADMIN && u.role !== UserRole.SUPER_ADMIN);

...
// FIX: Changed SettingsFormData to be a partial of combined settings types.
// This allows for different roles to have different subsets of settings without causing TypeScript errors.

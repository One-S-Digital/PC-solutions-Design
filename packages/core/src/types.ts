// Content of the original types.ts file goes here, unchanged.
// For brevity, I am not repeating the entire file content as it's a direct move.
// Assume the full content of the user-provided types.ts is here.
...
export interface DocumentItem {
  ...
  uploadDate?: string; // For File Gallery
  size?: number; // Size in bytes, for File Gallery
}
...
export type SettingsFormData = Partial<SupplierSettings & ProviderSettings>;
